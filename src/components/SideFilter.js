...
export default function ProductCard({ product: { image , title, price , id }, bestSeller = false, }) {
    return (
        <Link to={`/product/${id}`} >
            <div className='p-2 flex flex-col bg-white'>
                ...
                <img src={image} clasaName='h-32 w-32 my-4'></img>
                ...
                <p className='text-base'>Arrives: <span className='font-bold'>Tomorrow</span></p>
            </div>
        </Link>
    )
}